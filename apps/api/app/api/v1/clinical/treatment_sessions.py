...
@router.get("", response_model=PaginatedResponse[TreatmentSessionResponse], summary="List treatment sessions", description="List treatment sessions, optionally filtered by patient.")
